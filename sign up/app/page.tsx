        ...
        <div className="lg:w-[45%] bg-[#0f0f16] p-5 flex flex-col">
          ...
          >
            <div className="text-white text-xl font-bold tracking-wider">
              <span className="bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent">CAPITAXYZ</span>
            </div>
          ...
          >
            <Image
              src="https://ri.id-360occ.org/img/bg/AumentoODismnC.png"
            ...
            >
              <h2 className="text-white text-xl font-semibold leading-tight tracking-tight">
                Navegacion Financiera,
                <br />
                Navega hacia la prosperidad.
              </h2>
            </div>
          </div>
